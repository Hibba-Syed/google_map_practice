          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                const Divider(),
               TextWidget(title : 'Custom Date' ,date: now.year.toString()+"/"+now.month.toString()+"/"+now.hour.toString()+"-"+now.minute.toString()),
                const Divider(),
                TextWidget(title: 'Date',date: DateFormat.d().format(now),),
                TextWidget(title: 'Day Name',date: DateFormat.EEEE().format(now),),
                TextWidget(title: 'Short Day Name',date: DateFormat.E().format(now),),
                const Divider(),
                ...
                const Divider(),
                const Text('Days Ago'),
                Text("${DatesUtils().daysAgo(DateTime.now().microsecondsSinceEpoch.toString())},${DatesUtils().daysAgo(DateTime(now.year, now.month, now.day-1).microsecondsSinceEpoch.toString())},${DatesUtils().daysAgo(DateTime(now.year, now.month, now.day-2).microsecondsSinceEpoch.toString())},${DatesUtils().daysAgo(DateTime(now.year, now.month, now.day-10).microsecondsSinceEpoch.toString())}" ,
