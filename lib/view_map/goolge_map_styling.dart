                ...
                PopupMenuItem(
                  onTap: ()async{
                    ...
                    _controller.future.then((value){
                      ...
                      DefaultAssetBundle.of(context).loadString('assets/night_style.json').then((string) {
                        setState(() {
                ...
                PopupMenuItem(
                  onTap: ()async{
                    ...
                    _controller.future.then((value){
                      ...
                      DefaultAssetBundle.of(context).loadString('assets/aubergine_style.json').then((string) {
                        setState(() {
                ...
                PopupMenuItem (
                  onTap: ()async{
                    ...
                    _controller.future.then((value){
                      ...
                      DefaultAssetBundle.of(context).loadString('assets/silver_style.json').then((string) {
                        setState(() {
